...
public class GoogleFitModule extends ReactContextBaseJavaModule implements
    ...
    @ReactMethod
    public void getDetailedSteps(double startDate,
                                 double endDate,
                                 Callback errorCallback,
                                 Callback successCallback) {
        try {
            successCallback.invoke(mGoogleFitManager.getStepHistory().displayDetailedSteps((long) startDate, (long) endDate));
    ...
    @ReactMethod
    public void getSummary(double startDate,
                           double endDate,
                           Callback errorCallback,
                           Callback successCallback) {
        try {
            successCallback.invoke(mGoogleFitManager.getStepHistory().displaySummary((long) startDate, (long) endDate));
        } catch (IllegalViewOperationException e) {
            errorCallback.invoke(e.getMessage());
        }
    }
